...
} from '@mobile/services/hiker';
import { batchFetch, fetch } from '@mobile/services/hiker/request/asyncAxios';
...
export { BaseSpider, getProxy, joinUrl, local, md5X } from '@mobile/services/hiker';
